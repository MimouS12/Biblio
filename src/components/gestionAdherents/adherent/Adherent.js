...
import {bannirAdherent ,activerAdherent} from "../../../services/adherents.service"
      ...
      {!updateMode ? (
        ...
        <tr>
           ...
           **bannir just bech tbaddel el statu ta3 l'adherent
           ...
           <Link to={`/adminPage/ListeAdherents/${id}`}> <td className="detailsAdh" >Détails</td></Link> 
           <Link to={`/adminPage/emprunts/${id}`}> <td className="empruntAdh">Livres empruntés</td></Link> 
