  ...
  describe("test add new book ", ()=>{
      test("should the EAN be a number", ()=>{
        ...
        const  EAN="anndb"
           ...
           expect(()=>addBook( books, EAN)).toThrowError(/number/gi);
      })
        ...
        test("should the edition be a number", ()=>{
          ...
          const  edition="tyujks"
           
             expect(()=>addBook( books, edition)).toThrowError(/number/gi);
        })
  
    test("should the book be added to an empty list book", ()=>{
       const books = [
            {id :"1",
             //Code-barres EAN
             EAN:9782714411501,
      ...
      EAN =9144522654455,
         ...
         expected={
          ...
          expect(addBook(books,{EAN, libelle,auteur,edition,nbExemplaires})).toStrictEqual(expected);
